function openModal() {
	...
	myInput.onkeyup = function() {
       console.log('helllooo')
        ...
        // Password and Confirm Password Match" changes from red to green after both values
        //  are entered in the password fields. If they dont match, it needs to move from green to red POINTS: 2
...
function enableButton(letter, capital, number, length, match) {
    ...
    // (myInput.value.length >= minLength && myInput.value.match(numbers) && myInput.value.match(upperCaseLetters) && myInput.value.match(lowerCaseLetters)); // TODO: Replace false with the correct condition
    if(condition) {
